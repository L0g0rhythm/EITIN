# EITIN_Modular/Core/UIEnhancements.ps1

<#
.SYNOPSIS
    Escreve um cabeçalho formatado e centralizado no console.
.DESCRIPTION
    Cria uma borda superior e inferior com um título centralizado, usado no início da execução do script.
#>
